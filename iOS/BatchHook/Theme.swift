...
enum Theme {
    static let accent = Color(hex: "#8B2E3C")
    static let accentSecondary = Color(hex: "#3D5A45")
    static let background = Color(hex: "#F3EAE4")
    static let cardBackground = Color.white.opacity(0.7)
    static let textPrimary = Color(hex: "#8B2E3C").opacity(0.95)
